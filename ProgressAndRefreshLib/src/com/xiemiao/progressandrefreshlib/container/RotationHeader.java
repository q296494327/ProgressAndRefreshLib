...
public class RotationHeader extends BaseHeader {
    ...
    public View getView(LayoutInflater inflater,ViewGroup viewGroup) {
        ...
        progress1.setIndeterminateDrawable(context.getResources().getDrawable(rotationSrc));
        progress2.setIndeterminateDrawable(context.getResources().getDrawable(rotationFuSrc));
        progress3.setIndeterminateDrawable(context.getResources().getDrawable(rotationFuSrc));
        progress4.setIndeterminateDrawable(context.getResources().getDrawable(rotationSrc));
        progress5.setIndeterminateDrawable(context.getResources().getDrawable(rotationFuSrc));
        return view;
    }
